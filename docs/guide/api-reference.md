...
`EngineAdapter` is the extensibility seam — see `07-ARCHITECTURE.md` §3.
...
Adding an engine: implement `EngineAdapter`, pass the conformance suite, register it — see
`07-ARCHITECTURE.md` §5–§7.
